...
input_dir=/gscratch/spe/gvisan01/peptide_designs/ebv/hpvg/hcnn_pyrosetta_annealing/annealing_runs
output_dir=/gscratch/spe/gvisan01/peptide_designs/ebv/hpvg/hcnn_pyrosetta_annealing/plots

pdbs='3mv7.pdb.human.MH1.B-35.A.C.DE'
