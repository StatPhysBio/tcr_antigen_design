...
if __name__ == '__main__':
    ...
    for hcnn_model in ['so3_convnet_base_ensemble', 'so3_convnet_noise=0p5']:
        ...
        template_row = 'human	1	B*35:01	{seq}	TRAV20*01	TRAJ58*01	CAVQDLGTSGSRLTF	TRBV9*01	TRBJ2-2*01	CASSARSGELFF	4prp.pdb.human.MH1.B-35.A.C.DE	{hcnn_model}	{pnlogp}'
