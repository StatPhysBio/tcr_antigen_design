...
if __name__ == '__main__':
    ...
    for hcnn_model in ['so3_convnet_base_ensemble', 'so3_convnet_noise=0p5']:
        ...
        template_row = 'human	1	A*01:01	{seq}	TRAV21*01	TRAJ28*01	CAVRPGGAGPFFVVF	TRBV5-1*01	TRBJ2-7*01	CASSFNMATGQYF	5bs0.pdb.human.MH1.A-01.A.C.DE	{hcnn_model}	{pnlogp}'
