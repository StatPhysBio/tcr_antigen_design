...
if __name__ == '__main__':
    ...
    pdbdir = '/gscratch/spe/gvisan01/tcr_pmhc/peptide_designs/magea3_and_titin/magea3/pdbs/'
    pdbid = '5brz.pdb.human.MH1.A-01.A.C.DE'
    ...
    for sampling_temp in [0.1, 0.4, 0.7]:
        ...
        template_row = 'human	1	A*01:01	{seq}	TRAV21*01	TRAJ28*01	CAVRPGGAGPFFVVF	TRBV5-1*01	TRBJ2-7*01	CASSFNMATGQYF	{pdbid}	esmif'
