...
if __name__ == '__main__':
    ...
    parser.add_argument('-m',  '--model_version', type=str, nargs='+', default=['hermes_py_000', 'hermes_py_050']) # hermes_py_000 hermes_py_050 hermes_py_000_ft_skempi_no_tcrpmhc_ddg_bi hermes_py_050_ft_skempi_no_tcrpmhc_ddg_bi')
    ...
    for model_version in args.model_version:
        output_dir = f'./hermes_scores/{model_version}/with_relaxation'
        os.makedirs(output_dir, exist_ok=True)

        df = pd.read_csv('selected_designs_for_hermes_scoring.csv')
    
        for pdb, df_group in df.groupby('pdb'):
            ...
            for i, row in df_group.iterrows():
                ...
                for j in range(num_jobs):
                    ...
                    identifier = f'mage_{model_version}_{pdb}_{sequence}_{j}'
                    ...
                    slurm_text += f"python ../../mutation_effects/src/get_score_of_requested_peptide_in_pdb_of_tcr_pmhc_with_relaxation.py \
