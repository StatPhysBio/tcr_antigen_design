...
for model_version in $model_version_list
    ...
    for metric in $metrics
        ...
        python ../src/gather_score_with_relaxation_results.py \
                        --experiment_dir ./ \
                        --csv_filename 'nyeso_peptide_kd_closest_af3_yes_template.csv' \
                        --pdbid from_csv \
                        --model_version $model_version \
                        --pdb_column pdb
        ...
        python -u pretty_plots.py \
                    --base_dir ../ \
                    --system nyeso \
                    --system_name_in_csv_file 'nyeso_peptide_kd_closest_af3_yes_template_with_relaxation' \
                    --target_column'=-log10(Kd)' \
                    --prediction_column $metric \
                    --model hermes \
                    --model_instance $model_version \
        ...
        #             --base_dir ../ \
        #             --system nyeso \
        #             --system_name_in_csv_file 'nyeso_peptide_kd_closest_with_relaxation_min_energy' \
        #             --target_column'=-log10(Kd)' \
        #             --prediction_column $metric \
        #             --model hermes \
        #             --model_instance $model_version \
        ...
        #             --base_dir ../ \
        #             --system nyeso \
        #             --system_name_in_csv_file 'nyeso_peptide_kd_closest_with_relaxation_mean_but_min_energy_runs' \
        #             --target_column'=-log10(Kd)' \
        #             --prediction_column $metric \
        #             --model hermes \
        #             --model_instance $model_version \
