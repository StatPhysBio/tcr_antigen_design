...
# save df to csv
df.to_csv('nyeso_peptide_kd_averaged.csv', index=False)
...
df = pd.read_csv('results/tcrdock/nyeso_peptide_kd_w_pae.tsv', sep='\t')
...
df.to_csv('results/tcrdock/nyeso_peptide_kd_w_pae_filtered.tsv', sep='\t', index=False)




df = pd.read_csv('results/tcrdock_no_nearby_templates/nyeso_peptide_kd_no_nearby_templates_w_pae.tsv', sep='\t')
...
df.to_csv('results/tcrdock_no_nearby_templates/nyeso_peptide_kd_no_nearby_templates_w_pae_filtered.tsv', sep='\t', index=False)
