...
#                     --pdbdir ./pdbs \
#                     --output_csv_filepath $output_dir$model_version'/tax_peptide_kd_'$pdb'-'$model_version'-use_mt_structure=0.csv' \
#                     --csv_filepath 'tax_peptide_kd_'$pdb'.csv' \
#                     --pdb_column pdb \
#                     --chain_column chain \
...
for model_version in $model_version_list
    ...
    python -u ../../src/get_score_of_requested_peptides_fixed_structure.py \
                --model_version $model_version \
                --pdbdir ./pdbs \
                --output_csv_filepath $output_dir$model_version'/tax_peptide_kd_closest-'$model_version'-use_mt_structure=0.csv' \
