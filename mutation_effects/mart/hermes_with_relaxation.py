...
if __name__ == '__main__':
    ...
    parser.add_argument('-m',  '--model_version', type=str, nargs='+', default=['hermes_py_000', 'hermes_py_050', 'hermes_py_000_ft_skempi_no_tcrpmhc_ddg_bi', 'hermes_py_050_ft_skempi_no_tcrpmhc_ddg_bi']) # hermes_py_050 hermes_py_000_ft_skempi_no_tcrpmhc_ddg_bi hermes_py_050_ft_skempi_no_tcrpmhc_ddg_bi')
    ...
    for model_version in args.model_version:
        ...
        for pdb in PDBS:
            df = pd.read_csv(f'mart_peptide_kd_{pdb}.csv')
            for i, row in df.iterrows():
                ...
                for j in range(num_jobs):
                    ...
                    identifier = f'mart_{model_version}_{pdb}_{sequence}_{j}'
