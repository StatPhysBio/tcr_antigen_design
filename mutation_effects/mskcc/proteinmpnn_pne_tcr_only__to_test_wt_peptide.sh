...
for tcr in $tcrs
    ...
    for model_version in $model_version_list
        ...
        python $proteinmpnn_dir'score_multiple_peptides_and_or_arbitrary_residues__full_masked.py' \
                    ...
                    --output_dir $base_dir'results/proteinmpnn_'$model_version'_full_tcr_masked_fixed_wt_peptide_shuld_be_constant' \
                    --model_version $model_version \
                    --pdb_column wt_pdb \
                    --chain_column mutant_chain \
                    --peptides_column sequence \
                    --requested_regions interacting_TCR_residues \
        ...
        python -u pretty_plots.py \
                    ...
                    --model proteinmpnn \
                    --model_instance 'proteinmpnn_'$model_version'_full_tcr_masked_fixed_wt_peptide_shuld_be_constant' \
                    --num_seq_per_target 10 \
